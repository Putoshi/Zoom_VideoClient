# Video
This toturial present a glance and the common usage for the video stream APIs. Please check the API docs for more detail.

## Summary
This section introduce the video stream APIs provided by Zoom Instant SDK. All the methods can be accessed by a stream instance as mentioned before.
